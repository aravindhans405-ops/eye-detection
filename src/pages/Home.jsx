...
export default function Home() {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex flex-col">
      {/* Hero Section */}
      <section className="relative flex-grow flex items-center py-16 lg:py-24 px-4 overflow-hidden">
      ...
      {/* Features Section */}
      <section className="py-20 px-4" style={{ background: 'rgba(22,22,58,0.5)' }}>
        <div className="max-w-7xl mx-auto">
      ...
      <footer className="border-t border-indigo-500/10 py-8 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-slate-400">AI Eye Detection System © 2026</span>
          </div>
